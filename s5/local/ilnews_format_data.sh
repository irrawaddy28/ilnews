...
for x in train test; do 
  mkdir -p data/$x
  cp $srcdir/${x}_wav.scp data/$x/wav.scp || exit 1; sleep 2;  
  cp $srcdir/$x.txt data/$x/text || exit 1; sleep 2;  
  cp $srcdir/$x.spk2utt data/$x/spk2utt || exit 1; sleep 2;  
  cp $srcdir/$x.utt2spk data/$x/utt2spk || exit 1; sleep 2;  
  utils/filter_scp.pl data/$x/spk2utt $srcdir/spk2gender > data/$x/spk2gender || exit 1; sleep 2;  
done
